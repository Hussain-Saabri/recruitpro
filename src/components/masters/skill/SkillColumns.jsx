...
import React, { useMemo } from "react";
import { Tooltip } from "../../../components/ui";
import { Edit2, Trash2, Brain, Tag, AlignLeft, Code, Activity, Settings } from "lucide-react";
        ...
        cell: ({ row }) => {
          ...
          return (
            <div className="flex flex-col min-w-0 py-1">
              <span className="font-semibold text-[14px] text-gray-700 truncate">{skill.name}</span>
            </div>
          );
        },
      },
