      ...
      <div className="p-5 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Input
            ...
            onChange={(e) => {
              setJdData({ ...jdData, requirementId: e.target.value });
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <Dropdown
            ...
            options={[
              { label: "Contract to Hire", value: "contract_hire" },
              { label: "Employer Payroll", value: "employer_payroll" }
            ]}
            value="contract_hire"
            onChange={(e) => {
        ...
        <div className="flex flex-col text-left">
          <Textarea
            ...
            labelIcon={
              <span className="font-mono font-bold text-[10px] bg-brand-100 text-brand-700 px-1 rounded">
                &lt;/&gt;
              </span>
            }
